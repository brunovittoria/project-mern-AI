            ...
            <Box sx={{ display: { md: "flex", xs: "none", sm: "none"}, flex: 0.2, flexDirection: "column"}}>
                <Box sx={{ display: "flex", width:"100%", height:"60vh", bgcolor: "rgb(17,29,39)", borderRadius: 5, flexDirection: "column", mx: 3, }}>
                    <Avatar sx={{ mx:"auto", my: 2, bgcolor: "white", color: "black", fontWeight: 700, }}>
                        {auth?.user?.name[0]}{auth?.user?.name.split("")[1][0]} {/*Serve pra deixar com 2 letras a ft de perfil*/}
                    </Avatar>
                    <Typography sx={{ mx: "auto", fontFamily: "work sans" }}>
                        You are talking to a AI BOT
                    </Typography>
                    <Typography sx={{ mx: "auto", fontFamily: "work sans", my: 4, p: 3}}>
                        Ask me everything! But avoid sharing personal information...
                    </Typography>
